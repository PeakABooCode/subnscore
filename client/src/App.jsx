        ...
        <nav className="bg-slate-900 text-white shadow-md sticky top-0 z-40">
          <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            <div className="font-bold text-lg flex items-center gap-2">
              <Activity className="text-amber-400" /> SubNScore - Hoops Stats &
              Subs
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="p-4 flex flex-wrap gap-3">
            {roster
              ...
              .map((p) => {
                // Grab the stats for the bench player just like we do for court players
                ...
                return (
                  ...
                  >
                    ...
                    {/* Real-time stats display for bench player */}
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <Clock size={18} className="text-blue-500" /> Use Timeout (
